help:
	...
	@echo "https://github.com/qgis/QGIS-UG-Algeria"
	@echo
	@echo "------------------------------------------------------------------"
...
build: ## Build the site for dz.qgis.org
	@echo
	@echo "------------------------------------------------------------------"
...
deploy: ## Deploy the site for dz.qgis.org
	@echo
	@echo "------------------------------------------------------------------"
...
revert-deploy: ## Revert the site for dz.qgis.org
	@echo
	@echo "------------------------------------------------------------------"
